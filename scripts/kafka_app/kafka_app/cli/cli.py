...
def parse_args():
    ...
    parser.add_argument("-ps", "--producer_stream", action="store_true", help="Producer is streaming")
    parser.add_argument("-p", "--production", action="store_true", help="Production to stream a file")
